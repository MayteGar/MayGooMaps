package com.example.mayte.maygoomaps;
...
public class MainActivity extends ActionBarActivity implements GoogleMap.OnMapClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googlemap.addMarker(new MarkerOptions().position(casa).title("ITCA").snippet("Instituto Tecnologico de Cd. Altamirano").icon(BitmapDescriptorFactory.fromResource(android.R.drawable.ic_menu_compass)).anchor(0.5f, 0.5f));
        googlemap.setOnMapClickListener(this);

    }

    public void moveCamera(View view) {
        CameraPosition cameraPosition = new CameraPosition.Builder().target(new LatLng(18.371104, -100.680355)).zoom(15).build();
